...
package com.ydh.lib.retrofit.subsciber;

import android.content.Context;
import android.text.TextUtils;

import com.ydh.lib.retrofit.callback.CallBack;
import com.ydh.lib.retrofit.callback.DownloadProgressCallBack;
import com.ydh.lib.retrofit.exception.AiThrowable;
...
public class DownloadSubscriber<ResponseBody extends okhttp3.ResponseBody> extends BaseSubscriber<ResponseBody> {
    ...
    @Override
    public void onError(final AiThrowable e) {
    ...
    private void finalonError(final Exception e) {
        ...
        //if (Utils.checkMain()) {
        Observable.just(new AiThrowable(e, 100)).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<AiThrowable>() {
            @Override
            public void accept(@NonNull AiThrowable e) throws Exception {
                if (mCallBack != null) {
                    mCallBack.onError(e);
                }
            }
