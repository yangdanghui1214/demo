...
package com.ydh.lib_retrofit3.util;
...
public class Utils {
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) RetrofitUtils.getCxt().getSystemService(Context.CONNECTIVITY_SERVICE);
