...
package com.ydh.lib_retrofit3.retrofit.callback;
 ...
 * 版本： v1.0<br>
 */
public abstract class CallBackProxy<T extends BasicResponse<R>, R> implements IType<T> {
    private Type type;


    public CallBackProxy(Type type) {
        this.type = type;
    }
